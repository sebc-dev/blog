export default {
  ...
  'footer.builtWith': 'Créé avec Astro',
  ...
  // SEO
  'seo.defaultDescription': 'Un blog technique bilingue couvrant le développement web, la programmation et les tendances technologiques.',
} as const;